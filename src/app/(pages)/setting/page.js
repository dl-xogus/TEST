            ...
            <div className={style.inner}>
                ...
                <div className={style.content}>
                        ...
                        <div className={style.accountGrid}>
                            ...
                            <div className={style.loginCard}>
                                ...
                                <div className={style.loginType}>
                                    <img src="/img/icon/ic-setting-kakao.png" alt="" />
                                    <p>Kakao</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={style.infoList}>
                            {modify ? (
                                <div className={`${style.infoName} ${style.modify}`}>
                                    <input type="text" defaultValue="단밤 포차" />
                                </div>
                            ) : (
                            ...
                            {modify ? (
                                <div className={`${style.infoAdd} ${style.modify}`}>
                                    <input type="text" defaultValue="경기도 의정부시" />
                                </div>
                            ) : (
                    ...
                    <div className={style.actionArea}>
                        {modify && (
                            <button type="button" className={style.cancelBtn} onClick={() => setModify(false)}>
                                취소
                            </button>
                        )}
                        <button type="button" className={style.submitBtn} onClick={() => setModify(true)}>수정</button>
                    </div>
