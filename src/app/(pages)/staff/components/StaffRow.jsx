    ...
    <div className={styles.tableRow}>
      ...
      {isEdit ? (
        <>
          ...
          <span><input name="phone" placeholder="전화번호" value={editData.phone} onChange={handleChange} /></span>
        ...
        <>
          ...
          <span data-label="근무요일">
            {emp.days || '-'}
          </span>

          <span data-label="근무시간">
            {emp.time || '-'}
          </span>
